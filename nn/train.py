from . import dataset
from .architecture import MMCNN
...
def main(args):
    ...
    # OS stuff
    data_dir = args.data_dir + '/' if args.data_dir is not None else 'data/init-data'

    if args.use_temp_folder:
        model_dir = 'trained_models/test/'
    else:
        model_dir = 'trained_models/' + args.model_dir + '/'
    ...
    dataset = LidarDataset(data_dir=data_dir)
...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Create and delete temporary models folder during prototyping"
    )
    argparser.add_argument(
        "--data_dir",

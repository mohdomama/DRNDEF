...
X_RANGE = np.linspace(0, 40, 321) # Difference is exactly 0.5
TH_RANGE = None

# EGOLOC = carla.Transform(carla.Location(x=227.002968, y=250.089096, z=1.001809),
#                          carla.Rotation(pitch=-0.016358, yaw=0.0, roll=0.000000))

EGOLOC = carla.Transform(carla.Location(x=308.002968, y=144.3, z=1.001809), 

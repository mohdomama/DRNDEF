...
EGOLOC = carla.Transform(carla.Location(x=-510.211029, y=252.617813, z=0.542385), carla.Rotation(pitch=0.009344, yaw=-89.545067, roll=0.000000))
TR_LOC = []
S = [2.5] * len(TR_LOC)

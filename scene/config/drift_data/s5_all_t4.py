...
EGOLOC = carla.Transform(carla.Location(x=10.237675, y=40.220982, z=0.542386), carla.Rotation(pitch=0.008845, yaw=90.292191, roll=0.000000))
TR_LOC = []
S = [2.5] * len(TR_LOC)

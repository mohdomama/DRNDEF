...
EGOLOC = carla.Transform(carla.Location(x=-108.600456, y=-89.685577, z=0.542410), carla.Rotation(pitch=0.000533, yaw=0.022494, roll=0.000000))
TR_LOC = []
S = [2.5] * len(TR_LOC)

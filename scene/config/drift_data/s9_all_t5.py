...
EGOLOC = carla.Transform(carla.Location(x=-189.758759, y=-13.464871, z=0.507865), carla.Rotation(pitch=-0.000765, yaw=-90.060002, roll=0.000000))
TR_LOC = []
S = [2.5] * len(TR_LOC)

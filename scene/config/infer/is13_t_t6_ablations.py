...
TR_LOC = [
    carla.Transform(carla.Location(x=340.002968, y=238.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    ...
    carla.Transform(carla.Location(x=385.002968, y=245.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=370.002968, y=245.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=393.002968, y=250.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000))
]
S = [ -1, -1, -1, -1] 

...
TR_LOC = [
    ...
    carla.Transform(carla.Location(x=380.002968, y=243.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=375.002968, y=247.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),

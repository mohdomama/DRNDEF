...
EGOLOC = carla.Transform(carla.Location(x=152.614532, y=199.875168, z=3.015579), carla.Rotation(pitch=-1.276426, yaw=180.076407, roll=0.004011))


#### Traffic
TRAFFIC = False
TR_LOC = [ 
    carla.Transform(carla.Location(x=152.614532, y=210.875168, z=3.015579), carla.Rotation(pitch=-1.276426, yaw=180.076407, roll=0.004011)),
    carla.Transform(carla.Location(x=152.614532, y=186.875168, z=3.015579), carla.Rotation(pitch=-1.276426, yaw=180.076407, roll=0.004011)),
    ]
S = [2.5] * len(TR_LOC)

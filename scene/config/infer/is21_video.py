...
TR_LOC = [
    # carla.Transform(carla.Location(x=368.002968, y=248.089096, z=1.001809),
    #                 carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    # carla.Transform(carla.Location(x=376.002968, y=241.089096, z=1.001809),
    #                 carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=368.002968, y=245.089096, z=1.001809),
                    carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=362.002968, y=245.089096, z=1.001809),
                    carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    # carla.Transform(carla.Location(x=350.002968, y=244.089096, z=1.001809),
    #                 carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000)),
    carla.Transform(carla.Location(x=300.002968, y=248.089096, z=1.001809),
                    carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000))
]
S = [-1, -1, -1]

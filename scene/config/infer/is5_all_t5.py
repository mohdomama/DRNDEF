...
EGOLOC = carla.Transform(carla.Location(x=-63.847115, y=-140.287872, z=0.507862), carla.Rotation(pitch=0.000061, yaw=180.068332, roll=0.000000))
TR_LOC = []
S = [2.5] * len(TR_LOC)

...
EGOLOC = carla.Transform(carla.Location(x=400.002968, y=245.089096, z=1.001809), carla.Rotation(pitch=-0.016358, yaw=180.0, roll=0.000000))
...
y_L1 = list(np.linspace(255, 255, n_props))

x_R1 = list(np.linspace(450, 200, n_props))
